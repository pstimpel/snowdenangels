...
<head>
    ...
    <meta name="designer" content="Pete"/>

    <link rel="shortcut icon" href="https://RedZoneAction.org/sgasupport/favicon.png" type="image/png"/>
    <link rel="icon" href="https://RedZoneAction.org/sgasupport/favicon.png" type="image/png"/>
